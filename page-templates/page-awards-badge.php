...
if (isset($_REQUEST['award'])) {
	...
	<div style="width:285px; height: 80px; margin: 5px;background-image:url(<?php echo get_stylesheet_directory_uri(); ?>/images/window-cleaning.png);">
		...
		<a href="http://www.windowcleaning.com" target="_blank"><img style="padding: 0px 0px 0px 47px;"src="<?php echo get_stylesheet_directory_uri(); ?>/images/best-window-cleaners.png" alt="" />
		</a>
	</div>
	<?php
}
