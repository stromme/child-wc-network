...
if (isset($_REQUEST['award'])) {
	...
	<div style="width:285px; height: 80px; margin: 5px;background-image:url(<?php bloginfo('template_directory') ?>/images/window-cleaning.png);">
		...
		<a href="http://www.windowcleaning.com" target="_blank"><img style="padding: 0px 0px 0px 47px;"src="<?php bloginfo('template_directory') ?>/images/best-window-cleaners.png" alt="" />
		</a>
	</div>
	<?php
}
